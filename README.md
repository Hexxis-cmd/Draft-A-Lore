...
If you only want to use the app, take a file from the latest release — no source code needed:

DraftALore.html — the entire app in one file. Save it and open it in any browser.
DraftALore.apk — Android build for direct installation.
...
Draft A Lore is available for noncommercial use under the terms in LICENSE.md. Commercial use of the app itself requires a separate agreement; see COMMERCIAL-LICENSE.md.
